            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm text-left">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 font-medium text-gray-500">Numero de mesa</th>
                  <th className="px-6 py-3 font-medium text-gray-500">Disponibilidad</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4">Reservada</td>
                </tr>
              </tbody>
            </table>
          </div>
