            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm text-left">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 font-medium text-gray-500">Postre</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4">Helado caliente</td>
                  <td className="px-6 py-4">Helado sabor chocolate envuelto en pan caliente</td>
                </tr>
              </tbody>
            </table>
          </div>
